...
SYSTEM_EVENT_TYPES: frozenset[str] = frozenset({
    ...
    # Billing / cost accounting (Phase 16 — system-level, not always cycle-scoped)
    ...
    "BILLING_LOG_FAILED",
    # Pricing engine (deterministic computation, not always cycle-scoped)
    "PRICING_EV_COMPUTED",
    "WEB_UNHANDLED_EXCEPTION",
    # SSE / dashboard (not cycle-scoped)
    "SSE_CONNECTION_LOST",
    "SSE_INVALID_JSON",
})
